...
recipecount = input("Choose how many recipe results you would like!")
#sort by rating, set up url 
payload = {"key": api_key, "count": recipecount, "recipes": "title", "q":foodchoice}
...
p1 = Histogram(df, "social_rank", color = "lavender", fill_alpha = 1, bar_width=1.9, bins=200, title="Social Rank of Recipe by Interval")
